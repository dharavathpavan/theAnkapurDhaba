        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap lg:justify-end">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-green-600 px-4 py-3 font-display text-xs tracking-widest text-white shadow-lg shadow-green-600/30 hover:bg-green-500"
            >

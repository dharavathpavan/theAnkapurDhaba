    ...
    return (
      <div className="mx-auto max-w-md px-4 py-20 text-center">
        ...
        <p className="mt-2 text-zinc-500">
          Add biryani, curries, breads or desserts to start your order.
        </p>
        <Link
          to="/menu"
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_380px]">
        <section className="space-y-3">
            ...
            <div className="rounded-3xl bg-green-50 p-4 text-green-800">
              ...
              <div className="mt-3 h-2 overflow-hidden rounded-full bg-green-100">
                <div
                  ...
                  style={{
                    width: `${Math.min(100, (subtotal / (store?.freeDeliveryAbove ?? 499)) * 100)}%`,
                  }}
                />
              </div>
            </div>
          ) : (
            <div className="rounded-3xl bg-green-600 p-4 font-black text-white">
          ...
          {lines.map((line) => (
            <article
              ...
              className="flex gap-3 rounded-3xl bg-white p-3 shadow-sm ring-1 ring-zinc-100"
            >
              <img
        ...
        <aside className="h-fit rounded-[28px] bg-white p-5 shadow-sm ring-1 ring-zinc-100">
          <div className="flex items-center gap-2 text-red-600">
            ...
            <span className="font-black">Coupons available at checkout</span>
          </div>

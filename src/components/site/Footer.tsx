        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2">
              <MapPin className="h-4 w-4 mt-0.5 text-primary" /> NH-44, Ankapur, Telangana
            </li>
            <li className="flex gap-2">
              <Phone className="h-4 w-4 mt-0.5 text-primary" /> +91 98765 43210
            </li>
            <li className="flex gap-2">
              <Clock className="h-4 w-4 mt-0.5 text-primary" /> 11:00 AM — 11:30 PM
            </li>
          </ul>
        </div>
        <div>

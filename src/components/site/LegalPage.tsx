      ...
      <article className="mx-auto max-w-4xl overflow-hidden rounded-[32px] border border-zinc-200 bg-white shadow-sm">
        <header className="bg-zinc-950 px-5 py-8 text-white md:px-10">
          <Link to="/" className="inline-flex items-center gap-3">
            ...
            />
            <span>
              <span className="block text-xs font-black uppercase tracking-[0.24em] text-red-300">
                {LEGAL_BUSINESS.brand}
              </span>
          ...
          <p className="mt-5 text-xs font-bold uppercase tracking-[0.18em] text-white/45">
            Last updated: {LEGAL_BUSINESS.updated}
          </p>
        </header>
        ...
        <div className="grid gap-6 px-5 py-7 md:px-10">
          ...
          <section className="rounded-3xl border border-red-100 bg-red-50 p-5">
            ...
            <div className="mt-3 grid gap-2 text-sm leading-6 text-zinc-700">
              <p>
                <strong>Business:</strong> {LEGAL_BUSINESS.legalName}
              </p>
              <p>
                <strong>Address:</strong> {LEGAL_BUSINESS.address}
              </p>
              <p>
                <strong>Phone:</strong>{" "}
                <a className="font-bold text-red-600" href={`tel:${LEGAL_BUSINESS.phone}`}>
                  {LEGAL_BUSINESS.phone}
                </a>
              </p>
              <p>
                <strong>Email:</strong>{" "}
                <a className="font-bold text-red-600" href={`mailto:${LEGAL_BUSINESS.email}`}>
